...
usando football-data.org (gratis per sempre per queste competizioni).
Il calendario viene salvato nello stato condiviso e usato da
monitor_news.py per cercare in modo mirato formazioni ufficiali e
assenze/turnover.
